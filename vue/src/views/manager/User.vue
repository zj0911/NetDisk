<template>
  <div>
    <div class="search">
      <el-input placeholder="Enter username" style="width: 200px" v-model="username"></el-input>
    ...
    <el-dialog title="User" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="TEL" prop="phone">
          <el-input v-model="form.phone" placeholder="TEL"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // del(id) {   // 单个删除
    //   this.$confirm('Are you sure you want to delete?', '确认删除', {type: "warning"}).then(response => {
