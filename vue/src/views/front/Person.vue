<template>
  <div class="main-content">
    ...
    <el-dialog title="Change Password" :visible.sync="dialogVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="user" label-width="150px" style="padding-right: 20px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="Check password" prop="confirmPassword">
          <el-input show-password v-model="user.confirmPassword" placeholder="Check password"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  data() {
    const validatePassword = (rule, value, callback) => {
      if (value === '') {
        callback(new Error('Check password'))
